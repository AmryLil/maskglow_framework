...
@section('content')
    ...
    <div class="shadow-lg rounded-lg bg-white pt-24 p-4">
        <div class="flex justify-between mb-6 w-full items-center bg-slate-50 p-4 rounded-xl">
            <div
                class="flex bg-slate-900 text-xl text-slate-50 justify-between items-center rounded font-semibold w-full p-4 py-3 rounded-xl shadow-md">
                <div>Kelola Data Kategori</div>
                <div class="flex gap-4">
                    <a href="{{ route('dashboard.category_products.create') }}">
                        <button class="btn btn-primary h-10 px-6 text-lg text-white">Tambah Kategori</button>
                    </a>
                </div>
            </div>
        </div>
