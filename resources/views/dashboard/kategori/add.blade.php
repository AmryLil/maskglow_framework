    ...
    <div class="container mx-auto p-4 pt-20">
        ...
        <form class="bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="mb-5">
                ...
                <input type="text" name="nama_222290" id="nama_222290" class="border border-gray-300 p-3 rounded-lg w-full"
            ...
            <button class="bg-blue-500 hover:bg-blue-600 text-white font-bold px-4 py-2 rounded-lg">Simpan
                Kategori</button>
        </form>
    </div>
@endsection
